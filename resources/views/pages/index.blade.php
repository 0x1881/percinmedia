<x-layouts.app>
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="video-right">
                        <a href="https://www.youtube.com/watch?v=Cn4G2lZ_g2I" class="video-btn video-popup wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <img src="{{ Vite::asset('resources/assets/img/hero/text-circle.png') }}" alt="img">
                        </a>
    ...
    <section class="audience-section fix section-padding bg-cover" style="background-image: url('{{ Vite::asset('resources/assets/img/audience-bg.jpg') }}');">
        <div class="container">
    ...
    <section class="pricing-section fix section-padding section-bg">
        <div class="left-shape float-bob-y">
            <img src="{{ Vite::asset('resources/assets/img/pricing-left.png') }}" alt="img">
        </div>
        <div class="right-shape float-bob-y">
            <img src="{{ Vite::asset('resources/assets/img/pricing-right.png') }}" alt="img">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-4">
                    <div class="pricing-content">
                        ...
                        <div class="pricing-tab-header mt-4 mt-md-0">
                            <div class="arrow-shape">
                                <img src="{{ Vite::asset('resources/assets/img/arrow.png') }}" alt="img">
                            </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                                    <div class="pricing-box-items">
                                        <div class="pricing-header">
                                            ...
                                            <div class="icon">
                                                <img src="{{ Vite::asset('resources/assets/img/cloud.png') }}" alt="img">
                                            </div>
                                        </div>
                                        <ul class="price-list">
                                            <li>
                                            ...
                                            <li>
                                                <span class="price-1 color-2"><i class="fa-solid fa-xmark"></i> DedicatedÂ IP Address</span>
                                                <span class="icon"><i class="fa-regular fa-circle-question"></i></span>
                                            </li>
                                            <li>
                                        ...
                                        <div class="price-button">
                                            <a href="pricing.html" class="theme-btn">Get Started Now <i class="fa-regular fa-arrow-right-long"></i></a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-xl-2 col-lg-4">
                        <div class="testimonial-left wow fadeInUp" data-wow-delay=".3s">
                            <div class="client-img">
                                <img src="{{ Vite::asset('resources/assets/img/testimonial/10.png') }}" alt="img">
                                <div class="content">
                                    <div class="star">
                                        <i class="fa-solid fa-star"></i>
                                        <i class="fa-solid fa-star"></i>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="testimonial-box-items">
                                        ...
                                        <div class="testimonial-img">
                                            <img src="{{ Vite::asset('resources/assets/img/testimonial/01.png') }}" alt="img">
                                            <div class="shape-img">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-box-items">
                                        ...
                                        <div class="testimonial-img">
                                            <img src="{{ Vite::asset('resources/assets/img/testimonial/02.png') }}" alt="img">
                                            <div class="shape-img">
                                                <img src="{{ Vite::asset('resources/assets/img/testimonial/shape.png') }}" alt="img">
                                            </div>
                                        </div>
